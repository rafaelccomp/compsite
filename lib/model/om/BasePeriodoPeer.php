...
abstract class BasePeriodoPeer {
	...
	const DESCRIPTION = 'Periodo.DESCRIPTION';

	/** the column name for the GRADE_ID field */
	const GRADE_ID = 'Periodo.GRADE_ID';

	/**
	 * An identiy map to hold any loaded instances of Periodo objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Description', 'GradeId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'description', 'gradeId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DESCRIPTION, self::GRADE_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'description', 'grade_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Description' => 1, 'GradeId' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'description' => 1, 'gradeId' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DESCRIPTION => 1, self::GRADE_ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'description' => 1, 'grade_id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PeriodoPeer::DESCRIPTION);
		$criteria->addSelectColumn(PeriodoPeer::GRADE_ID);
	}
	 ...
	 *
	 * @param      Periodo $value A Periodo object.
	...
	/**
	 * Selects a collection of Periodo objects pre-filled with their Grade objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinGrade(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Periodo) to $obj2 (Grade)
	...
	{
		return $withPrefix ? PeriodoPeer::CLASS_DEFAULT : PeriodoPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePeriodoPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePeriodoPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePeriodoPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePeriodoPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePeriodoPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePeriodoPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePeriodoPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePeriodoPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			PeriodoPeer::doOnDeleteSetNull(new Criteria(PeriodoPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			PeriodoPeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = PeriodoPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {

			// set fkey col in related Gradeunit rows to NULL
			$selectCriteria = new Criteria(PeriodoPeer::DATABASE_NAME);
			$updateValues = new Criteria(PeriodoPeer::DATABASE_NAME);
			$selectCriteria->add(GradeunitPeer::PERIODO_ID, $obj->getId());
			$updateValues->add(GradeunitPeer::PERIODO_ID, null);
