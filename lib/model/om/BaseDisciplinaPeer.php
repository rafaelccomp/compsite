...
abstract class BaseDisciplinaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Disciplina';
	...
	const DESCRIPTION = 'Disciplina.DESCRIPTION';

	/** the column name for the CH field */
	const CH = 'Disciplina.CH';

	/** the column name for the CONTENT_ID field */
	const CONTENT_ID = 'Disciplina.CONTENT_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Description', 'Ch', 'ContentId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'description', 'ch', 'contentId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DESCRIPTION, self::CH, self::CONTENT_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'description', 'ch', 'content_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Description' => 1, 'Ch' => 2, 'ContentId' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'description' => 1, 'ch' => 2, 'contentId' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DESCRIPTION => 1, self::CH => 2, self::CONTENT_ID => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'description' => 1, 'ch' => 2, 'content_id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		$criteria->addSelectColumn(DisciplinaPeer::ID);
		$criteria->addSelectColumn(DisciplinaPeer::DESCRIPTION);
		$criteria->addSelectColumn(DisciplinaPeer::CH);
		$criteria->addSelectColumn(DisciplinaPeer::CONTENT_ID);
	}
	...
	/**
	 * Selects a collection of Disciplina objects pre-filled with their Content objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinContent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		DisciplinaPeer::addSelectColumns($criteria);
		$startcol = (DisciplinaPeer::NUM_COLUMNS - DisciplinaPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Disciplina) to $obj2 (Content)
    ...
    foreach (sfMixer::getCallables('BaseDisciplinaPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseDisciplinaPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(DisciplinaPeer::ID) && $criteria->keyContainsValue(DisciplinaPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.DisciplinaPeer::ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseDisciplinaPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseDisciplinaPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(DisciplinaPeer::ID);
			$selectCriteria->add(DisciplinaPeer::ID, $criteria->remove(DisciplinaPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			DisciplinaPeer::doOnDeleteSetNull(new Criteria(DisciplinaPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(DisciplinaPeer::ID, (array) $values, Criteria::IN);
		}
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			DisciplinaPeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = DisciplinaPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {

			// set fkey col in related Gradeunit rows to NULL
			$selectCriteria = new Criteria(DisciplinaPeer::DATABASE_NAME);
			$updateValues = new Criteria(DisciplinaPeer::DATABASE_NAME);
			$selectCriteria->add(GradeunitPeer::DISCIPLINA_ID, $obj->getId());
			$updateValues->add(GradeunitPeer::DISCIPLINA_ID, null);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(DisciplinaPeer::ID, $pk);
