...
abstract class BaseContentPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CreatedAt', 'UpdatedAt', 'Content', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdAt', 'updatedAt', 'content', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CREATED_AT, self::UPDATED_AT, self::CONTENT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'created_at', 'updated_at', 'content', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CreatedAt' => 1, 'UpdatedAt' => 2, 'Content' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdAt' => 1, 'updatedAt' => 2, 'content' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CREATED_AT => 1, self::UPDATED_AT => 2, self::CONTENT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'created_at' => 1, 'updated_at' => 2, 'content' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ContentPeer::CONTENT);
	}
	...
	{
		// invalidate objects in DisciplinaPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			ContentPeer::doOnDeleteSetNull(new Criteria(ContentPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			ContentPeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// set fkey col in related Disciplina rows to NULL
			$selectCriteria = new Criteria(ContentPeer::DATABASE_NAME);
			$updateValues = new Criteria(ContentPeer::DATABASE_NAME);
			$selectCriteria->add(DisciplinaPeer::CONTENT_ID, $obj->getId());
			$updateValues->add(DisciplinaPeer::CONTENT_ID, null);
			...
			$selectCriteria = new Criteria(ContentPeer::DATABASE_NAME);
			$updateValues = new Criteria(ContentPeer::DATABASE_NAME);
			$selectCriteria->add(CmspagePeer::CONTENT_ID, $obj->getId());
			$updateValues->add(CmspagePeer::CONTENT_ID, null);
