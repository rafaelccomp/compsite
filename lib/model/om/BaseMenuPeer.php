...
abstract class BaseMenuPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Ordem', 'Parent', 'Caption', 'Link', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'ordem', 'parent', 'caption', 'link', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ORDEM, self::PARENT, self::CAPTION, self::LINK, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'ordem', 'parent', 'caption', 'link', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Ordem' => 1, 'Parent' => 2, 'Caption' => 3, 'Link' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'ordem' => 1, 'parent' => 2, 'caption' => 3, 'link' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ORDEM => 1, self::PARENT => 2, self::CAPTION => 3, self::LINK => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'ordem' => 1, 'parent' => 2, 'caption' => 3, 'link' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MenuPeer::ORDEM);
		$criteria->addSelectColumn(MenuPeer::PARENT);
		$criteria->addSelectColumn(MenuPeer::CAPTION);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			MenuPeer::doOnDeleteSetNull(new Criteria(MenuPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			MenuPeer::doOnDeleteSetNull($criteria, $con);
