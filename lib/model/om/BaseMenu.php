...
abstract class BaseMenu extends BaseObject  implements Persistent {
	 ...
	 */
	protected $collMenusRelatedByParent;

	/**
	 * @var        Criteria The criteria used to select the current contents of collMenusRelatedByParent.
	 */
	private $lastMenuRelatedByParentCriteria = null;
	...
	public function setOrdem($v)
	{
		...
		if ($this->ordem !== $v) {
			$this->ordem = $v;
			$this->modifiedColumns[] = MenuPeer::ORDEM;
		}
	...
	public function setCaption($v)
	{
		...
		if ($this->caption !== $v) {
			$this->caption = $v;
			$this->modifiedColumns[] = MenuPeer::CAPTION;
		}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->aMenuRelatedByParent = null;
			$this->collMenusRelatedByParent = null;
			$this->lastMenuRelatedByParentCriteria = null;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MenuPeer::ORDEM)) $criteria->add(MenuPeer::ORDEM, $this->ordem);
		if ($this->isColumnModified(MenuPeer::PARENT)) $criteria->add(MenuPeer::PARENT, $this->parent);
		if ($this->isColumnModified(MenuPeer::CAPTION)) $criteria->add(MenuPeer::CAPTION, $this->caption);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getMenusRelatedByParent() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addMenuRelatedByParent($relObj->copy($deepCopy));
				}
			}
	 ...
	 * @throws     PropelException
	 */
	public function getMenuRelatedByParent(PropelPDO $con = null)
	{
		if ($this->aMenuRelatedByParent === null && ($this->parent !== null)) {
			$this->aMenuRelatedByParent = MenuPeer::retrieveByPk($this->parent);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aMenuRelatedByParent->addMenusRelatedByParent($this);
			 */
		}
	...
	/**
	 * Clears out the collMenusRelatedByParent collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addMenusRelatedByParent()
	 */
	public function clearMenusRelatedByParent()
	{
		$this->collMenusRelatedByParent = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collMenusRelatedByParent collection (array).
	 *
	 * By default this just sets the collMenusRelatedByParent collection to an empty array (like clearcollMenusRelatedByParent());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initMenusRelatedByParent()
	{
		$this->collMenusRelatedByParent = array();
	}
	 ...
	 * related MenusRelatedByParent from storage. If this Menu is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getMenusRelatedByParent($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(MenuPeer::DATABASE_NAME);
		}
		...
		if ($this->collMenusRelatedByParent === null) {
			if ($this->isNew()) {
			   $this->collMenusRelatedByParent = array();
				...
				$this->collMenusRelatedByParent = MenuPeer::doSelect($criteria, $con);
			}
		} else {
		...
		$this->lastMenuRelatedByParentCriteria = $criteria;
		return $this->collMenusRelatedByParent;
	}
	 ...
	 * @throws     PropelException
	 */
	public function addMenuRelatedByParent(Menu $l)
	{
		if ($this->collMenusRelatedByParent === null) {
			$this->initMenusRelatedByParent();
		}
		if (!in_array($l, $this->collMenusRelatedByParent, true)) { // only add it if the **same** object is not already associated
			array_push($this->collMenusRelatedByParent, $l);
			$l->setMenuRelatedByParent($this);
		}
	}
	...
	{
		if ($deep) {
			if ($this->collMenusRelatedByParent) {
				foreach ((array) $this->collMenusRelatedByParent as $o) {
