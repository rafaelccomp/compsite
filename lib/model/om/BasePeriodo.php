...
abstract class BasePeriodo extends BaseObject  implements Persistent {
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = PeriodoPeer::DESCRIPTION;
		}
	...
	public function setGradeId($v)
	{
		...
		if ($this->grade_id !== $v) {
			$this->grade_id = $v;
			$this->modifiedColumns[] = PeriodoPeer::GRADE_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = PeriodoPeer::NUM_COLUMNS - PeriodoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PeriodoPeer::DESCRIPTION)) $criteria->add(PeriodoPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(PeriodoPeer::GRADE_ID)) $criteria->add(PeriodoPeer::GRADE_ID, $this->grade_id);
	...
	{
	  if (!$callable = sfMixer::getCallable('BasePeriodo:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BasePeriodo::%s', $method));
	  }
