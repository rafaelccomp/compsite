...
/**
 * Base static class for performing query and update operations on the 'Horario' table.
 *
 * 
 *
...
abstract class BaseHorarioPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Horario objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Inicio', 'Fim', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'inicio', 'fim', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::INICIO, self::FIM, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'inicio', 'fim', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Inicio' => 1, 'Fim' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'inicio' => 1, 'fim' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::INICIO => 1, self::FIM => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'inicio' => 1, 'fim' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(HorarioPeer::INICIO);
		$criteria->addSelectColumn(HorarioPeer::FIM);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseHorarioPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Horario $value A Horario object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Horario $obj, $key = null)
	{
	...
	public static function buildTableMap()
	{
	  ...
	  {
	    $dbMap->addTableObject(new HorarioTableMap());
	  }
	}
	...
	{
		return $withPrefix ? HorarioPeer::CLASS_DEFAULT : HorarioPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Horario or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseHorarioPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseHorarioPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseHorarioPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseHorarioPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Horario or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseHorarioPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseHorarioPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseHorarioPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseHorarioPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the Horario table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			HorarioPeer::doOnDeleteSetNull(new Criteria(HorarioPeer::DATABASE_NAME), $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Horario or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			HorarioPeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = HorarioPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {

			// set fkey col in related Gradeunit rows to NULL
			$selectCriteria = new Criteria(HorarioPeer::DATABASE_NAME);
			$updateValues = new Criteria(HorarioPeer::DATABASE_NAME);
			$selectCriteria->add(GradeunitPeer::HORARIO_ID, $obj->getId());
			$updateValues->add(GradeunitPeer::HORARIO_ID, null);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseHorarioPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
