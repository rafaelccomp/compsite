...
abstract class BaseGrade extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array Periodo[] Collection to store aggregation of Periodo objects.
	 */
	protected $collPeriodos;

	/**
	 * @var        Criteria The criteria used to select the current contents of collPeriodos.
	 */
	...
	public function setPublished($v)
	{
		...
		if ($this->published !== $v) {
			$this->published = $v;
			$this->modifiedColumns[] = GradePeer::PUBLISHED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->published = ($row[$startcol + 1] !== null) ? (boolean) $row[$startcol + 1] : null;
			...
			return $startcol + 3; // 3 = GradePeer::NUM_COLUMNS - GradePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GradePeer::PUBLISHED)) $criteria->add(GradePeer::PUBLISHED, $this->published);
	...
	/**
	 * Clears out the collPeriodos collection (array).
	 *
	...
	/**
	 * Initializes the collPeriodos collection (array).
	 *
	...
	/**
	 * Gets an array of Periodo objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Grade has previously been saved, it will retrieve
	 * related Periodos from storage. If this Grade is new, it will return
	...
	public function addPeriodo(Periodo $l)
	{
		...
		if (!in_array($l, $this->collPeriodos, true)) { // only add it if the **same** object is not already associated
			array_push($this->collPeriodos, $l);
			$l->setGrade($this);
		}
	}
