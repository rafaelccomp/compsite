...
class MenuTableMap extends TableMap {
	...
	{
    $this->addRelation('MenuRelatedByParent', 'Menu', RelationMap::MANY_TO_ONE, array('parent' => 'id', ), 'SET NULL', null);
    $this->addRelation('MenuRelatedByParent', 'Menu', RelationMap::ONE_TO_MANY, array('id' => 'parent', ), 'SET NULL', null);
	} // buildRelations()
