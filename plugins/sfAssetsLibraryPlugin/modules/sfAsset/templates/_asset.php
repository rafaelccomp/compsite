  ...
  <div class="assetComment">
    ...
    <div class="details">
      ...
      <?php if (!$sf_user->hasAttribute('popup', 'sf_admin/sf_asset/navigation')): ?>
        <?php echo link_to(image_tag('/sfAssetsLibraryPlugin/images/delete.png', 'alt=delete class=deleteImage align=top'), '@sf_asset_library_delete_asset?id='.$sf_asset->getId(), array('title' => __('Delete'), 'method' => 'delete', 'confirm' => __('Are you sure?'))) ?>
      <?php endif ?>
    </div>
  </div>
</div>
